...
int usbh_initialize(uint8_t busid, uintptr_t reg_base, usbh_event_handler_t event_handler)
{
    ...
    /* Embox port: auto-generated symbols for the C-identifier section
     * usbh_class_info (see usbh_core.h CLASS_INFO_DEFINE). */
    extern uint32_t __start_usbh_class_info;
    extern uint32_t __stop_usbh_class_info;
    usbh_class_info_table_begin = (struct usbh_class_info *)&__start_usbh_class_info;
    usbh_class_info_table_end = (struct usbh_class_info *)&__stop_usbh_class_info;
